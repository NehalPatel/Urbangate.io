...
<?php if($user->user_id) { ?>
	...
	@section('navItemUser', 'kt-menu__item--open')
<?php } else { ?>
	@section('title', 'Add User')
	@section('pageTitle', 'Add User')

	@section('navItemUser', 'kt-menu__item--open')
	@section('navItemUserAdd', 'kt-menu__item--active')
<?php } ?>
			...
			<div class="kt-subheader__main">
				...
				<div class="kt-subheader__group" id="kt_subheader_search">
					<span class="kt-subheader__desc" id="kt_subheader_total">
						@if($user->user_id){{ $user->full_name }}@endif </span>
				</div>
			</div>
			<div class="kt-subheader__toolbar">
				<a href="{{ route('admin.panel.users') }}" class="btn btn-default btn-bold">
					Back </a>
				<div class="btn-group">
										...
										<div class="kt-section__body">
											<div class="row">
												...
												<div class="col-lg-9 col-xl-6">
													<h3 class="kt-section__title kt-section__title-sm">User Account Info:</h3>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<div class="input-group">
														...
														<input type="email" class="form-control" id="email" name="email" value="{{ $user->email }}" autocomplete="off" placeholder="Email" aria-describedby="basic-addon1">
														<div class="invalid-feedback"></div>
													</div>
												</div>
											</div>
											...
											<div class="kt-form__actions">
												<div class="row">
													...
													<div class="col-lg-9 col-xl-6">
														...
														<a href="{{ route('admin.panel.user.listing') }}" class="btn btn-clean btn-bold">Cancel</a>
													</div>
												</div>
											</div>
									...
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											<div class="row">
												<label class="col-xl-3"></label>
												<div class="col-lg-9 col-xl-6">
													<h3 class="kt-section__title kt-section__title-sm">User Account Settings:</h3>
												</div>
											</div>
												...
												<div class="col-lg-9 col-xl-6">
													<div class="kt-radio-inline">
														<label class="kt-radio">
															<input type="radio" name="status" value="<?php echo Status::$ACTIVE; ?>" <?php echo $user->status == Status::$ACTIVE ? 'checked' : ''; ?>/> Active
															<span></span>
														</label>
														<label class="kt-radio">
															<input type="radio" name="status" value="<?php echo Status::$INACTIVE; ?>" <?php echo $user->status == Status::$INACTIVE ? 'checked' : ''; ?>/> Inactive
															<span></span>
														</label>
														<label class="kt-radio">
															<input type="radio" name="status" value="<?php echo Status::$PENDING; ?>" <?php echo $user->status == Status::$PENDING ? 'checked' : ''; ?>/> Pending
															<span></span>
														</label>
														<label class="kt-radio">
															<input type="radio" name="status" value="<?php echo Status::$APPROVED; ?>" <?php echo $user->status == Status::$APPROVED ? 'checked' : ''; ?>/> Approved
															<span></span>
														</label>
													</div>
												</div>
	    ...
	    var initSubmit = function() {
	        ...
	        btn.on('click', function(e) {
	            ...
	            if (validator.form()) {
	                ...
	                formEl.ajaxSubmit({
	                	type: 'POST',
	                	url: "{{ route('admin.panel.user.save') }}",
	                    success: function(data, status) {
	                        ...
	                        if(data.status){ //success
		                        swal.fire({
		                        	...
		                        	window.location.href = "{{ route('admin.panel.user.listing') }}";
		                        });
	                        } else {
	                        	swal.fire({
		                            "title": "Error",
