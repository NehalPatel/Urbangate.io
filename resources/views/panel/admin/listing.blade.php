...
@section('title', 'Admins Listing')
@section('pageTitle', 'Admins Listing')

@section('navItemAdmin', 'kt-menu__item--open')
@section('navItemAdminListing', 'kt-menu__item--active')
	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				...
				<a href="{{ route('admin.panel.admin.add') }}" class="btn btn-label-brand btn-bold">
					{{ __("Add Admin") }} </a>
	...
	<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		...
		<div class="kt-portlet kt-portlet--mobile">
			<div class="kt-portlet__body kt-portlet__body--fit">
				...
				<!--begin: Datatable -->
				<div class="kt-datatable" id="kt_admins_list"></div>
...
var KTUserListDatatable = function() {
	...
	var init = function() {
		...
		datatable = $('#kt_admins_list').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						method: 'POST',
						url: '{{ route("admin.panel.admin.search") }}',
						params: {
							_token: token,
						},
				...
				afterTemplate: function(row, data, index) {
					$(row).off('click.delete').on('click.delete', '.atnDelete', function(e) {
						...
						mAlert.confirm('Are you sure?', 'You won\'t be able to revert this!', function() {
							...
							post_data('<?php echo route('admin.panel.admin.delete'); ?>', requestData, function(response) {
								if(response.status) {
			...
			},
			{
				...
				template: function(row) {
					...
					var editUrl = '<?php echo route('admin.panel.admin.edit', ['admin_id' => ':admin_id']); ?>';
					editUrl = editUrl.replace(':admin_id', row.admin_id);
					var atnEdit = `<a href="` + editUrl + `" class="btn m-btn m-btn--hover-info m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-edit"></i></a>`;
					actions += atnEdit;

					var atnDelete = `<a href="<?php echo route('admin.panel.admin.delete'); ?>" class="btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill atnDelete"><i class="la la-trash"></i></a>`;
					actions += atnDelete;
