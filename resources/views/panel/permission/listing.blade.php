...
@section('pageTitle', 'Permission Listing')

@section('navItemPermission', 'kt-menu__item--open')
@section('navItemPermissionListing', 'kt-menu__item--active')
	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				<a href="{{ route('admin.panel.permission.add') }}" class="btn btn-label-brand btn-bold">{{ __("Sync Permission") }} </a>
			</div>
		</div>
	</div>
	...
	<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		...
		<div class="kt-portlet kt-portlet--mobile">
			<div class="kt-portlet__body kt-portlet__body--fit">
				...
				<!--begin: Datatable -->
				<div class="kt-datatable" id="kt_permissions_list"></div>
		...
		<!--begin::Modal-->
		<div class="modal fade" id="kt_datatable_records_fetch_modal" tabindex="-1" permission="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="kt-scroll" data-scroll="true" data-height="200">
							<ul id="kt_apps_permission_fetch_records_selected"></ul>
						</div>
					</div>
...
var KTPermissionListDatatable = function() {
	...
	var init = function() {
		...
		datatable = $('#kt_permissions_list').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						method: 'POST',
						url: '{{ route("admin.panel.permission.search") }}',
						params: {
							_token: token,
						},
			...
			},
			{
				...
				template: function(row) {
					return row.name.replace(/_/g, " ").toUpperCase();
				}
			},
			{
				field: 'guard_name',
	...
	var selectedFetch = function() {
		...
		$('#kt_datatable_records_fetch_modal').on('show.bs.modal', function(e) {
			...
			$(e.target).find('#kt_apps_permission_fetch_records_selected').append(c);
		}).on('hide.bs.modal', function(e) {
			$(e.target).find('#kt_apps_permission_fetch_records_selected').empty();
		});
	};
...
KTUtil.ready(function() {
	KTPermissionListDatatable.init();
});
