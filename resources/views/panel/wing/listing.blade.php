...
@section('navItemWingListing', 'kt-menu__item--active')
	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				...
				<a href="{{ route('admin.panel.wing.add') }}" class="btn btn-label-brand btn-bold"> {{ __('Add New Wing') }} </a>
			</div>
		</div>
	</div>
...
var KTWingListDatatable = function() {
