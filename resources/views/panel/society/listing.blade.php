	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				...
				<a href="{{ route('admin.panel.society.add') }}" class="btn btn-label-brand btn-bold"> {{ __('Add New Society') }} </a>
			</div>
		</div>
	</div>
		...
		datatable = $('#kt_societies_list').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						method: 'POST',
						url: '{{ route("admin.panel.society.search") }}',
						params: {
							_token: token,
						},
				...
				afterTemplate: function(row, data, index) {
					$(row).off('click.delete').on('click.delete', '.atnDelete', function(e) {
						...
						mAlert.confirm('Are you sure?', 'You won\'t be able to revert this!', function() {
							...
							post_data('<?php echo route('admin.panel.society.delete'); ?>', requestData, function(response) {
								if(response.status) {
			...
			},
			{
				...
				template: function(row) {
					...
					var editUrl = '<?php echo route('admin.panel.society.edit', ['society_id' => ':society_id']); ?>';
					editUrl = editUrl.replace(':society_id', row.society_id);
					var atnEdit = `<a href="` + editUrl + `" class="btn btn-bold btn-sm btn-font-sm kt-font-success"><i class="la la-edit"></i></a>`;
					actions += atnEdit;

					var atnDelete = `<a href="<?php echo route('admin.panel.society.delete'); ?>" class="btn btn-bold btn-sm btn-font-sm kt-font-danger atnDelete"><i class="la la-trash"></i></a>`;
					actions += atnDelete;
