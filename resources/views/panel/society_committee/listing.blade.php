...
@section('title', 'Society Committee Listing')
@section('pageTitle', 'Society Committee Listing')

@section('navItemSocietyCommittee', 'kt-menu__item--open')
@section('navItemSocietyCommitteeListing', 'kt-menu__item--active')
	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				<a href="{{ route('admin.panel.societyCommittee.add') }}" class="btn btn-label-brand btn-bold"> {{ __('Add New Society Committee') }} </a>
			</div>
		</div>
	</div>
	...
	<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		...
		<div class="kt-portlet kt-portlet--mobile">
			<div class="kt-portlet__body kt-portlet__body--fit">
				...
				<!--begin: Datatable -->
				<div class="kt-datatable" id="kt_societies_list"></div>
...
var KTUserListDatatable = function() {
	...
	var init = function() {
		...
		datatable = $('#kt_societies_list').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						method: 'POST',
						url: '{{ route("admin.panel.wing.search") }}',
						params: {
							_token: token,
						},
				...
				afterTemplate: function(row, data, index) {
					$(row).off('click.delete').on('click.delete', '.atnDelete', function(e) {
						...
						mAlert.confirm('Are you sure?', 'You won\'t be able to revert this!', function() {
							...
							post_data('<?php echo route('admin.panel.wing.delete'); ?>', requestData, function(response) {
								if(response.status) {
			...
			},
			{
				...
				template: function(row) {
					...
					var editUrl = '<?php echo route('admin.panel.wing.edit', ['wing_id' => ':wing_id']); ?>';
					editUrl = editUrl.replace(':wing_id', row.wing_id);
					var atnEdit = `<a href="` + editUrl + `" class="btn btn-bold btn-sm btn-font-sm kt-font-success"><i class="la la-edit"></i></a>`;
					actions += atnEdit;

					var atnDelete = `<a href="<?php echo route('admin.panel.wing.delete'); ?>" class="btn btn-bold btn-sm btn-font-sm kt-font-danger atnDelete"><i class="la la-trash"></i></a>`;
					actions += atnDelete;
