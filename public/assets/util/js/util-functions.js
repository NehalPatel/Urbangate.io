...
function get_render_url(attachmentId) {
	if(attachmentId) {
		return g.base_url + '/attachment/render/' + attachmentId;
	}
	return g.base_url + '/assets/img/default-avatar.png';
}

function get_download_url(attachmentId) {
	return g.base_url + '/attachment/download/' + attachmentId;
}
