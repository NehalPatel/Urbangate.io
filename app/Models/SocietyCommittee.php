...
class SocietyCommittee extends Model
{
    ...
    protected $table = 'com_society_committees';
    ...
    public static function boot()
    {
        ...
        SocietyCommittee::creating(function($society)
        {
            $society->society_id = uuid();
            $society->society_no = UniqueNumberHelper::get_no('SocietyCommittee', 'SOC');
     ...
     * Each SocietyCommittee have multiple Wings/Bunglows
     * @return type
     */
    ...
    public static function get($society_id) {
        return SocietyCommittee::where('society_id', $society_id)->first();
    }
    ...
    public static function scopeSocietyCommitteeId($query, $society_id) {
        return $query->where('society_id', $society_id);
    }

    public static function scopeSocietyCommitteeNo($query, $society_no)
    {
